                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li class="active"><a href="#"><i class="material-icons">format_color_fill</i> UI Elements<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    ...
                                    <li class="active-link"><a href="note.html">Sticky Notes</a></li>
                ...
                <div class="page-content">
                    ...
                    <section class="content-header z-depth-1">
                        ...
                        <div class="header-title">
                            <h1> Note</h1>
                            <small> Use note for Syntax Highlighting.</small>
                                    ...
                                    <div class="card-content">
                                        <div class="row">
                                            <div class="col-xs-12 col-md-4">
                                                <div class="text yellow lighten-4 z-depth-1">
                                            ...
                                            <div class="col-xs-12 col-md-4">
                                                <div class="text teal lighten-4 z-depth-1">
                                                    <div class="content-text">
                                                        <h3 class="lead">
                                                            Project Title
                                                        </h3>
                                            ...
                                            <div class="col-xs-12 col-md-4">
                                                <div class="text red lighten-4 z-depth-1">
                                                    <div class="content-text">
                                                        <h3 class="lead">
                                                            Project Title
                                                        </h3>
                                            ...
                                            <div class="col-xs-12 col-md-4">
                                                <div class="text purple lighten-4 z-depth-1">
                                                    <div class="content-text">
                                                        <h3 class="lead">
                                                            Project Title
                                                        </h3>
                                            ...
                                            <div class="col-xs-12 col-md-4">
                                                <div class="text teal accent-1 z-depth-1">
                                                    <div class="content-text">
                                                        <h3 class="lead">
                                                            Note Title
                                                        </h3>
                                            ...
                                            <div class="col-xs-12 col-md-4">
                                                <div class="text yellow lighten-3 z-depth-1">
                                                    <div class="content-text">
                                                        <h3 class="lead">
                                                            Project Title
                                                        </h3>
                                            ...
                                            <div class="col-xs-12 col-md-4">
                                                <div class="text grey lighten-2 z-depth-1">
                                                    <div class="content-text">
                                                        <h3 class="lead">
                                                            Project Title
                                                        </h3>
                                            ...
                                            <div class="col-xs-12 col-md-4">
                                                <div class="text blue lighten-4 z-depth-1">
                                                    <div class="content-text">
                                                        <h3 class="lead">
                                                            Project Title
                                                        </h3>
