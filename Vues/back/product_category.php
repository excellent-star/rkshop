                    ...
                    <section class="content-header z-depth-1">
                        ...
                        <div class="header-title">
                            ...
                            <ul class="link hidden-xs">
                                ...
                                <li><a href="?p=sub_family">Catégorie Famille</a></li>
                            </ul>
                        </div>
                    </section>
                    <!-- page section -->
                                    ...
                                    <div class="card-header">
                                        ...
                                        <div>
                                          ...
                                          <div>
                                           ...
                                           <button style="background-color:#26A69A;" class="btn not-display-image" data-target="#add-product"  data-toggle="modal">Ajouter une Catégorie</button>
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="table-responsive">
                                            <table id="family-table" class="table table-bordered table-hover">
                                                ...
                                                <?php foreach($category_families as $key=> $family):   ?>
                                    ...
                                    <form action="" id="add-family-form">
                                        ...
                                        <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    <label style="font-size:16px;color:#26A69A;" for="nom-famille">Sous Famille <span class="text-danger">*</span></label>
                                                ...
                                                <div class="form-group">
                                                    <label style="font-size:16px;color:#26A69A;" for="nom-famille">Nom Catégorie <span class="text-danger">*</span></label>
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <form action="" id="update-family-form">
                                        ...
                                        <div class="form-group">
                                                    ...
                                                    <select name="nom-famille-top-update" id="top_family_name_update" class="" required>

                                                      <option id="familyTopName" value=""></option>
                                                ...
                                                <input type="hidden" id="id_top_family">
                                ...
                                var formData = new FormData();
                                 ...
                                 formData.append('image',image);
                                    ...
                                    $.ajax({
                                        ...
                                        url:"?p=<?= $fonction->double_cryptage("run_add_category");?>",
                                        type:"POST",
                                        dataType:"JSON",
                                        processData:false,
                                        contentType:false,
        ...
        <script>
            ...
            // when  update modal pops up 
                 ...
                 $("#update-product").on('show.bs.modal',function(e){
                       ...
                       var topId = button_data.family_top_id;
                       var topName = button_data.family_top_name;
                       ...
                       console.log(topName);
                        ...
                        // $(this).find("#familyTopName").text(topName);
                        $(this).find("#familyTopName").val(topId);


                        // $(this).find("#top_family_name_update").text(topName);
                       
                        $(this).find("#id_top_family").val(topId);
         ...
         <script>
                   ...
                   var family_name,nom,description,image;
...
// when user clicks on close modal button
  ...
  // when user submit the form
     ...
     $('#update-family-form').submit(function(e){
            ...
            family_name = $("#top_family_name_update").val();

            id_top_family = $("#id_top_family").val();
            


          console.log('top family id '+id_top_family);

          console.log('second top family id => '+family_name);
            ...
            formData.append('id_top',id_top_family);

            if(id_top_family!=family_name){

                 
             
              formData.append('id_top',family_name);
             ...
             formData.append('id',id);
                ...
                $.ajax({
                    ...
                    url:"?p=<?= $fonction->double_cryptage("run_update_category");?>",
                    type:"POST",
                    dataType:"JSON",
                    processData:false,
                    contentType:false,
                         ...
                         var id = $(this).attr('data-id');
                                ...
                                swal({
                                                            ...
                                                            $.ajax({
                                                                ...
                                                                url:"?p=<?= $fonction->double_cryptage("run_delete_category");?>",
                                                                type:"POST",
                                                                dataType:"JSON",
                                                                data:{id:id},
                                                                success:function(data){
                     ...
                     if(id==''){
                        ...
                        swal({
                                                            ...
                                                            $.ajax({
                                                                ...
                                                                url:"?p=<?= $fonction->double_cryptage("run_delete_many_categories");?>",
                                                                type:"POST",
                                                                dataType:"JSON",
                                                                data:{id:id},
                                                                success:function(data){
