<nav style="" class="navbar navbar-inverse navbar-fixed-top">
                <!-- Logo -->
                <a class="navbar-brand pull-left" href="index.html">
                    <img src="assets/assets_backend/dist/img/borderremove1.png" alt="logo" width="205" height="60">
                </a>
                <a id="menu-toggle">
                    ...
                    <ul class="navbar navbar-right">
                        ...
                        <li class="dropdown">
                            <a class='dropdown-button user-pro' href='#' data-activates='dropdown-user'>
                                <img src="assets/assets_backend/dist/img/rkshopowner.jpg" class="img-circle" height="45" width="50" alt="User Image">
                            </a>
