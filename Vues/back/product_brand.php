                                    ...
                                    <div class="card-header">
                                        ...
                                        <div>
                                          ...
                                          <div>
                                           ...
                                           <button style="background-color:#26A69A;" class="btn not-display-image" data-target="#add-product"  data-toggle="modal">Ajouter une marque</button>
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="table-responsive">
                                            <table id="family-table" class="table table-bordered table-hover">
                                                ...
                                                <?php foreach($brands as $key=> $family):   ?>
                                                    <tr>
                                                        <td>
                                                            <input type="checkbox" id="test<?=$key;?>" class="checkItem" value="<?=$family->marque_id;?>" name="id[]" />
                                                            <label for="test<?=$key;?>"></label>
                                                        </td>
                                                        <td><?=$family->marque_libelle;?></td>
                                                        
                                                        <td style="text-align: center;">

                                                              

                                                            <button class="btn btn-sm edit" data-id="<?=$family->marque_id;?>" data-nom="<?=$family->marque_libelle;?>"   data-placement="left" title="Update" data-target="#update-product"  data-toggle="modal"><i class="fa fa-pencil" aria-hidden="true"></i></button>


                                                            <button class="btn btn-danger btn-sm delete" data-toggle="tooltip" data-id="<?=$family->marque_id;?>" data-placement="right" title="Delete "><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                                                        </td>
                                                    </tr>
        ...
        <script>
                   ...
                   $(function(){
                    ...
                    $('#add-product').on("hide.bs.modal", function() {
                        ...
                        window.open("?p=<?= $fonction->double_cryptage("brand");?>","_self");
                         ...
                         $('#add-family-form').submit(function(e){
                                ...
                                //  formData.append('image',image);
                                    ...
                                    $.ajax({
                                        ...
                                        url:"?p=<?= $fonction->double_cryptage("run_add_brand");?>",
                                        type:"POST",
                                        dataType:"JSON",
                                        processData:false,
                                        contentType:false,
            ...
            //  formData.append('image',image);
             formData.append('id',id);
                ...
                $.ajax({
                    ...
                    url:"?p=<?= $fonction->double_cryptage("run_update_brand");?>",
                    type:"POST",
                    dataType:"JSON",
                    processData:false,
                    contentType:false,
                         ...
                         var id = $(this).attr('data-id');
                                ...
                                swal({
                                                            ...
                                                            $.ajax({
                                                                ...
                                                                url:"?p=<?= $fonction->double_cryptage("run_delete_brand");?>",
                                                                type:"POST",
                                                                dataType:"JSON",
                                                                data:{id:id},
                                                                success:function(data){
                     ...
                     if(id==''){
                        ...
                        swal({
                                                            ...
                                                            $.ajax({
                                                                ...
                                                                url:"?p=<?= $fonction->double_cryptage("run_delete_many_brands");?>",
                                                                type:"POST",
                                                                dataType:"JSON",
                                                                data:{id:id},
                                                                success:function(data){
