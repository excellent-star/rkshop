                                    ...
                                    <div class="card-header">
                                        ...
                                        <div>
                                          ...
                                          <div>
                                           ...
                                           <button style="background-color:#26A69A;" class="btn not-display-image" data-target="#add-product"  data-toggle="modal">Ajouter une Pointure</button>
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="table-responsive">
                                            <table id="family-table" class="table table-bordered table-hover">
                                                ...
                                                <?php foreach($sizes as $key=> $family):   ?>
                                                    <tr>
                                                        <td>
                                                            <input type="checkbox" id="test<?=$key;?>" class="checkItem" value="<?=$family->taille_pointure_id;?>" name="id[]" />
                                                            <label for="test<?=$key;?>"></label>
                                                        </td>
                                                        <td><?=$family->taille_pointure_libelle;?></td>
                                                        
                                                        <td style="text-align: center;">

                                                              

                                                            <button class="btn btn-sm edit" data-id="<?=$family->taille_pointure_id;?>" data-nom="<?=$family->taille_pointure_libelle;?>"   data-placement="left" title="Update" data-target="#update-product"  data-toggle="modal"><i class="fa fa-pencil" aria-hidden="true"></i></button>


                                                            <button class="btn btn-danger btn-sm delete" data-toggle="tooltip" data-id="<?=$family->taille_pointure_id;?>" data-placement="right" title="Delete "><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                                                        </td>
                                                    </tr>
                                    ...
                                    <form action="" id="add-family-form">
                                        ...
                                        <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="nom-famille"  placeholder="Nom Famille Produit" required>
        ...
        <script>
                   ...
                   $(function(){
                    ...
                    $('#add-product').on("hide.bs.modal", function() {
                        ...
                        window.open("?p=<?= $fonction->double_cryptage("shoeSize");?>","_self");
                         ...
                         $('#add-family-form').submit(function(e){
                                ...
                                //  formData.append('image',image);
                                    ...
                                    $.ajax({
                                        ...
                                        url:"?p=<?= $fonction->double_cryptage("run_add_shoeSize");?>",
                                        type:"POST",
                                        dataType:"JSON",
                                        processData:false,
                                        contentType:false,
            ...
            // when  update modal pops up 
                 ...
                 $("#update-product").on('show.bs.modal',function(e){
                    ...
                    //    var image = button_data.image;
                        ...
                        // var img = '<img style="width:150px;height:150px;" src="assets/images/brands/'+image+'"  />';
            ...
            //  formData.append('image',image);
             formData.append('id',id);
                ...
                $.ajax({
                    ...
                    url:"?p=<?= $fonction->double_cryptage("run_update_shoeSize");?>",
                    type:"POST",
                    dataType:"JSON",
                    processData:false,
                    contentType:false,
                ...
                $(function(){
                 ...
                 $("#view-product").on('show.bs.modal',function(e){
                       ...
                       var view_text_tag = '<p>'+description+'</p>';
                        ...
                        var img = '<img style="width:100%;height:300px;" src="assets/images/brands/'+image+'"  />';
                         ...
                         var id = $(this).attr('data-id');
                                ...
                                swal({
                                                            ...
                                                            $.ajax({
                                                                ...
                                                                url:"?p=<?= $fonction->double_cryptage("run_delete_shoeSize");?>",
                                                                type:"POST",
                                                                dataType:"JSON",
                                                                data:{id:id},
                                                                success:function(data){
                     ...
                     if(id==''){
                        ...
                        swal({
                                                            ...
                                                            $.ajax({
                                                                ...
                                                                url:"?p=<?= $fonction->double_cryptage("run_delete_many_shoeSizes");?>",
                                                                type:"POST",
                                                                dataType:"JSON",
                                                                data:{id:id},
                                                                success:function(data){
