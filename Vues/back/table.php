                    ...
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li class="active"><a><i class="material-icons">business</i>Tables<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    <li class="active-link"><a href="table.html">Simple tables</a></li>
                ...
                <div class="page-content">
                    ...
                    <section class="content-header z-depth-1">
                        ...
                        <div class="header-title">
                            <h1> Table</h1>
                            <small> Tables are a nice way to organize a lot of data.</small>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="card">
                                    <div class="card-header">
                                        <i class="fa fa-table fa-lg"></i>
                                        <h2>Bootstrap colorful table</h2>
                                    </div>
                                    <div class="card-content">
                                        <div class="table-responsive">
                                            <table class="table table-condensed">
                                                ...
                                                <tbody>
                                                    <tr class="active">
                                                        <th scope="row">1</th>
                                                        <td class="black-text">Mark</td>
                                                        <td class="black-text">Otto</td>
                                                        <td class="black-text">@mdo</td>
                                                    </tr>
                                                    ...
                                                    <tr class="pink darken-3">
                                                        <th scope="row">4</th>
                                                        <td>Larry</td>
                                                        <td>Jellybean</td>
                                                        <td>@lajelly</td>
                                                    </tr>
                                                    <tr class="deep-orange darken-1">
                                                        <th scope="row">5</th>
                                                        <td>Larry</td>
                                                        <td>Kikat</td>
                                                        <td>@lakitkat</td>
