                                    ...
                                    <div class="card-header">
                                        ...
                                        <div>
                                          ...
                                          <div>
                                           ...
                                           <button style="background-color:#26A69A;" class="btn not-display-image" data-target="#add-product"  data-toggle="modal">Ajouter une Taille</button>
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <form action="" id="add-family-form">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">Ajouter une taille</h4>
                                        </div>
        ...
        <script>
                   ...
                   $(function(){
                    ...
                    $('#add-product').on("hide.bs.modal", function() {
                        ...
                        window.open("?p=<?= $fonction->double_cryptage("size");?>","_self");
                         ...
                         $('#add-family-form').submit(function(e){
                                ...
                                //  formData.append('image',image);
                                    ...
                                    $.ajax({
                                        ...
                                        url:"?p=<?= $fonction->double_cryptage("run_add_size");?>",
                                        type:"POST",
                                        dataType:"JSON",
                                        processData:false,
                                        contentType:false,
            ...
            //  formData.append('image',image);
             formData.append('id',id);
                ...
                $.ajax({
                    ...
                    url:"?p=<?= $fonction->double_cryptage("run_update_size");?>",
                    type:"POST",
                    dataType:"JSON",
                    processData:false,
                    contentType:false,
                         ...
                         var id = $(this).attr('data-id');
                                ...
                                swal({
                                                            ...
                                                            $.ajax({
                                                                ...
                                                                url:"?p=<?= $fonction->double_cryptage("run_delete_size");?>",
                                                                type:"POST",
                                                                dataType:"JSON",
                                                                data:{id:id},
                                                                success:function(data){
                     ...
                     if(id==''){
                        ...
                        swal({
                                                            ...
                                                            $.ajax({
                                                                ...
                                                                url:"?p=<?= $fonction->double_cryptage("run_delete_many_sizes");?>",
                                                                type:"POST",
                                                                dataType:"JSON",
                                                                data:{id:id},
                                                                success:function(data){
