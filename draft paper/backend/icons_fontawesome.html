                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li class="active-link"><a href="icons_fontawesome.html">Fontawesome Icon</a></li>
                ...
                <div class="page-content">
                    ...
                    <section class="content-header z-depth-1">
                        ...
                        <div class="header-title">
                            ...
                            <small class="hidden-xs"> font-awesome Icons details & used</small>
                            <ul class="link hidden-xs">
                                <li><a href="index.html"><i class="fa fa-home"></i>Home</a></li>
                                <li><a href="icons_bootstrap.html">font-awesome Icons</a></li>
                            </ul>
                        </div>
                    </section>
                    <!-- page section -->
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="card">
                                    ...
                                    <div class="card-content">
                                        <!-- font-awesome icons -->
                                        <p class="m-b-20">You asked, Font Awesome delivers with 41 shiny new icons in version 4.7. Want to request new icons? Here's how. Need vectors or want to use on the desktop? Check the <a href="http://fontawesome.io/icons/" title="font-awesome" target="_blank">cheatsheet.</a></p>
