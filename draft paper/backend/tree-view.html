...
<html lang="en">
    ...
    <body>
                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li class="active"><a href="#"><i class="material-icons">format_color_fill</i> UI Elements<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    ...
                                    <li class="active-link"><a href="tree-view.html">Tree View</a></li>
                ...
                <div class="page-content">
                    ...
                    <section class="content-header z-depth-1">
                        ...
                        <div class="header-title">
                            <h1> Tree view</h1>
                            <small> Tree view details and use</small>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="card">
                                    ...
                                    <div class="card-content">
                                        <ul id="tree1">
                                            <li><p class="well"><strong>Initialization no parameters</strong>
        ...
        <!-- tree-view -->
        <script src="assets/plugins/tree-view/tree-view.min.js" type="text/javascript"></script>
        <!-- custom js -->
