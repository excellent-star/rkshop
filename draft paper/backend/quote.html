                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li class="active"><a href="#"><i class="material-icons">format_color_fill</i> UI Elements<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    ...
                                    <li class="active-link"><a href="quote.html">Quote</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="card">
                                    ...
                                    <div class="card-content">
                                        <blockquote class="block-summery">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="card">
                                    <div class="card-header">
                                        <i class="fa fa-comments fa-lg"></i>
                                        <h2>Different types of Quotes</h2>
                                    </div>
                                    <div class="card-content">
                                        <blockquote class="quote-card z-depth-1">
                                            <p>
                                        ...
                                        <blockquote class="quote-card blue-card z-depth-1">
                                            <p>
                                        ...
                                        <blockquote class="quote-card green-card z-depth-1">
                                            <p>
                                        ...
                                        <blockquote class="quote-card mate-card z-depth-1">
                                            <p>
                                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloremque at, architecto culpa sint veniam temporibus!!architecto culpa sint veniam temporibus!!
                                            </p>
                                            <cite>
                                                Lorem ipsum dolor
                                            </cite>
                                        </blockquote>
                                        <blockquote class="quote-card material-card z-depth-1">
                                            <p>
