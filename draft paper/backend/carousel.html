...
<html lang="en">
    ...
    <head>
        ...
        <!-- owl carousel  -->
        <link href="assets/plugins/OwlCarousel2/dist/assets/owl.carousel.min.css" rel="stylesheet" type="text/css" />
        <link href="assets/plugins/OwlCarousel2/dist/assets/owl.theme.default.css" rel="stylesheet" type="text/css" />
        <!-- jquery bxslider css -->
    ...
    <body>
                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li class="active"><a href="#"><i class="material-icons">format_color_fill</i> UI Elements<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    ...
                                    <li class="active-link"><a href="carousel.html">Slider</a></li>
                                </ul>
                            </li>
                                    ...
                                    <div class="card-content">
                                        <div class="bx-wrapper">
                                            <ul class="bxslider text-center">
                                                <li><img class="example-image" src="assets/dist/img/imgs/1.jpg" alt="image-1"></li>
                                                <li><img class="example-image" src="assets/dist/img/imgs/2.jpg" alt="image-2"></li>
                                                <li><img class="example-image" src="assets/dist/img/imgs/3.jpg" alt="image-3"></li>
                                                <li><img class="example-image" src="assets/dist/img/imgs/5.jpg" alt="image-4"></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content">
                                        <div class="owl-carousel owl-theme">
                                            <div class="item">
                                                <img class="example-image" src="assets/dist/img/imgs/1.jpg" alt="image-1" height="160" width="250">
                                            </div>
                                            <div class="item">
                                                <img class="example-image" src="assets/dist/img/imgs/2.jpg" alt="image-1" height="160" width="250" />
                                            </div>
                                            <div class="item">
                                                <img class="example-image" src="assets/dist/img/imgs/5.jpg" alt="image-1" height="160" width="250" />
                                            </div>
                                            <div class="item">
                                                <img class="example-image" src="assets/dist/img/imgs/6.jpg" alt="image-1" height="160" width="250" />
                                            </div>
                                            <div class="item">
                                                <img class="example-image" src="assets/dist/img/imgs/7.jpg" alt="image-1" height="160" width="250" />
                                            </div>
                                            <div class="item">
                                                <img class="example-image" src="assets/dist/img/imgs/5.jpg" alt="image-1" height="160" width="250" />
                                            </div>
                                            ...
                                            <div class="item">
                                                <img class="example-image" src="assets/dist/img/imgs/3.jpg" alt="image-1" height="160" width="250" />
                                            </div>
                                            <div class="item">
                                                <img class="example-image" src="assets/dist/img/imgs/5.jpg" alt="image-1" height="160" width="250" />
                                            </div>
        ...
        <!-- OwlCarousel 2  -->
        <script src="assets/plugins/OwlCarousel2/dist/owl.carousel.min.js" type="text/javascript"></script>
        <!-- jquery-bxslider -->
        <script src="assets/plugins/jquery-bxslider/jquery.bxslider.min.js" type="text/javascript"></script>
        <!-- m-custom-scrollbar -->
