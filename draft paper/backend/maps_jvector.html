...
<html lang="en">
    <head>
        ...
        <link href="assets/plugins/jvectormap/jquery-jvectormap-2.0.3.css" rel="stylesheet" type="text/css" />
    ...
    <body>
                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li class="active"><a><i class="material-icons">layers_clear</i>Maps<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    ...
                                    <li class="active-link"><a href="maps_jvector.html">Jvector Maps</a></li>
        ...
        <!-- Start Page Lavel Plugins
            =====================================================================-->
        <!-- Jvectoe map -->
        <script src="assets/plugins/jvectormap/jquery-jvectormap-2.0.3.min.js" type="text/javascript"></script>
        <script src="assets/plugins/jvectormap/jquery-jvectormap-world-mill-en.js" type="text/javascript"></script>
        <script src="assets/plugins/jvectormap/jquery-jvectormap-asia-mill.js" type="text/javascript"></script>
        <script src="assets/plugins/jvectormap/jquery-jvectormap-europe-mill.js" type="text/javascript"></script>
