                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li class="active-link"><a href="mailDetails.html">Mailbox Details</a></li>
                                ...
                                <aside class="lg-side">
                                    ...
                                    <div class="inbox-body">
                                        ...
                                        <div class="inbox-avatar inbox-brd p-20 border-btm">
                                            <img src="assets/dist/img/avatar5.png" class="border-green hidden-xs hidden-sm img-circle" width="60" height="50" alt="">
